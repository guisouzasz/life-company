...
const s = StyleSheet.create({
  ...
  // Coluna de leitura: no desktop o formulário fica centralizado em vez de
  // esticar a largura toda da tela; no celular ocupa tudo normalmente.
  cardInner: { width: '100%', maxWidth: 420, alignSelf: 'center' },
  errorBanner: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 8,
