          ...
          <Card padding={16}>
            <View style={s.diaInfoRow}>
              ...
              <Text style={s.diaInfo}>
                {diaSel.diaNome}, {diaSel.diaNum} — {treinoDia.data ? `salvo por ${treinoDia.data.professor.nome.split(' ')[0]} (${formatDate(treinoDia.data.updatedAt, 'DD/MM HH:mm')})` : 'ainda sem treino'}
              </Text>
            </View>
